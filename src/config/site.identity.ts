export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'mattralston',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Matt R Alston',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'mattralston.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://mattralston.net',
